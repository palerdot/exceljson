...
/***/ function(module, exports, __webpack_require__) {
	...
	window.App = _app2.default; // ref: https://github.com/webpack/imports-loader
	...
	console.log("this is ", undefined, window);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonFormatterJs = __webpack_require__(4);

	var _jsonFormatterJs2 = _interopRequireDefault(_jsonFormatterJs);

	var _clipboardJs = __webpack_require__(5);
	...
	var _d3Dsv = __webpack_require__(12);
	...
	var App = {
	    ...
	    initVueComponents: function initVueComponents() {
	        console.log("porumai! initing vue components");
	        _vue2.default.component("progress-bar", {
	            props: ["progress"],
	    ...
	    initUploadPane: function initUploadPane() {

	        this.uploadPane = new _vue2.default({
	            ...
	            computed: {
	                invalidFile: function invalidFile() {
	                    // file should not be empty; && should have valid extension
	                    return !_lodash2.default.isEmpty(this.file) && !this.fileValid;
	                },
	            ...
	            methods: {
	                ...
	                isFileEmpty: function isFileEmpty() {
	                    return _lodash2.default.isEmpty(this.file);
	                },
	                ...
	                handleColumnHeaderChange: function handleColumnHeaderChange() {
	                    console.log("handleColumnHeaderChange ", this.isColumnHeader, _typeof(this.isColumnHeader));
	                }
	            }
	    ...
	    initJSONPane: function initJSONPane() {
	        var _this = this;

	        var self = this; // save reference

	        this.jsonPane = new _vue2.default({
	            ...
	            computed: {
	                ...
	                JSONString: function JSONString() {
	                    ...
	                    if (this.validJSON) {
	                        var json = _lodash2.default.isEmpty(this.json) ? this.defaultJSON : this.json;
	                ...
	                defaultJSON: function defaultJSON() {
	                    return {
	                        "message": "Hello!"
	                    };
	                }
	            ...
	            methods: {
	                ...
	                handleJSONChange: _lodash2.default.debounce(function (e) {
	                    console.log("before ", _this.json);
	                    _this.jsonPane.json_string = $(e.target).val();
	                    // if valid json
	                    console.log("handling json change ", _this.json, _this.jsonPane.validJSON, _this.jsonPane.JSONString);
	                }, 550, {
	                    leading: false,
	                    trailing: true
	                }),
	                ...
	                copyJSON: function copyJSON() {
	                    ...
	                    _clipboardJs2.default.copy(text).then(function () {
	                        console.log("success");
	                ...
	                downloadCSV: function downloadCSV() {
	                    ...
	                    var is_array = _lodash2.default.isArray(this.getJSON());
	                    ...
	                    if (this.isColumnHeader) {
	                        try {
	                            parsed = (0, _d3Dsv.csvFormat)(this.getJSON());
	                            parse_error = false;
	                        } catch (e) {
	                            parse_error = true;
	                        ...
	                        try {
	                            parsed = (0, _d3Dsv.csvFormatRows)(this.getJSON());
	                            parse_error = false;
	                        } catch (e) {
	                            parse_error = true;
	                ...
	                downloadTSV: function downloadTSV() {
	                    ...
	                    if (this.isColumnHeader) {
	                        try {
	                            parsed = (0, _d3Dsv.tsvFormat)(this.getJSON());
	                            parse_error = false;
	                        } catch (e) {
	                            parse_error = true;
	                        ...
	                        try {
	                            parsed = (0, _d3Dsv.tsvFormatRows)(this.getJSON());
	                            parse_error = false;
	                        } catch (e) {
	                            parse_error = true;
	                ...
	                downloadFile: function downloadFile(content, file_type) {
	                    ...
	                    _fileSaver2.default.saveAs(file, filename);
	                }
	            }
	    ...
	    validateFileContent: function validateFileContent(file, content) {

	        // only csv, tsv files are allowed
	        var valid_file_types = ["text/csv", "text/tab-separated-values"];

	        var file_type = file && file.type,
	            file_valid = _lodash2.default.includes(valid_file_types, file_type);
	    ...
	    processCSVFile: function processCSVFile(content) {

	        var is_column_header = this.uploadPane.isColumnHeader,
	            parsed = false;

	        if (is_column_header) {
	            parsed = (0, _d3Dsv.csvParse)(content, function (d) {
	                return d;
	            });
	        } else {
	            parsed = (0, _d3Dsv.csvParseRows)(content, function (d) {
	                return d;
	            });
	        }
	    ...
	    processTSVFile: function processTSVFile(content) {

	        var is_column_header = this.uploadPane.isColumnHeader,
	            parsed = false;

	        if (is_column_header) {
	            parsed = (0, _d3Dsv.tsvParse)(content, function (d) {
	                return d;
	            });
	        } else {
	            parsed = (0, _d3Dsv.tsvParseRows)(content, function (d) {
	                return d;
	            });
	        }
	    ...
	    scrollToJSONPane: function scrollToJSONPane() {
	    ...
	    getFileReaderOptions: function getFileReaderOptions() {
	        ...
	        var options = {
	            ...
	            on: {
	                beforestart: function beforestart(e, file) {
	                ...
	                error: function error(e, file) {/* Native ProgressEvent */},
	                loadend: function loadend(e, file) {
	                ...
	                abort: function abort(e, file) {/* Native ProgressEvent */},
	                skip: function skip(e, file) {
	                ...
	                groupstart: function groupstart(group) {
	                    //
	                ...
	                groupend: function groupend(group) {
